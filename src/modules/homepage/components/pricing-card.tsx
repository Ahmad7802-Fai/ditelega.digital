...
export default function PricingCard({
  ...
  return (
    <Card
      ...
      hover={false}
      className={cn(
        "relative text-center p-8 transition-all duration-500",
    ...
    >
      ...
      {isHighlight && (
        <div
          className="
            absolute inset-0
            bg-gradient-to-br from-green-200/40 via-transparent to-green-300/30
            blur-2xl opacity-70
          "
        />
      )}
      ...
      {isHighlight && (
        <div
          className="
            ...
            bg-green-600 text-white text-xs px-4 py-1.5 rounded-full
            shadow-lg z-30
          "
        >
          🔥 Paling Laris
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-500 mt-1">/ paket</p>
