  ...
  return (
    <Section className="relative py-32 bg-gray-50 overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        ">
          Paket <span className="text-green-600">Google Ads</span>
        </h2>
        ...
        ">
          Pilih paket sesuai kebutuhan bisnis Anda. Semua paket sudah termasuk
          strategi, optimasi, dan reporting profesional.
        </p>
